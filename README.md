...
ex3 determines if a plant is ready based on its age.  
ex4 checks whether plants need watering.  
ex5 counts days until harvest using both iterative and recursive approaches.  
